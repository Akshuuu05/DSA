...
class Solution {
    ...
    public static void main(String[] args) {
        ...
        int[] fruits1 = { 3, 5, 1, 7 };
        int[] baskets1 = { 2, 4, 5, 8 };

        int[] fruits2 = { 2, 4, 6 };
        int[] baskets2 = { 1, 1, 1 };

        System.out.println("Unplaced Fruits (Test 1): " + sol.numOfUnplacedFruits(fruits1, baskets1)); // Expected: 0
        System.out.println("Unplaced Fruits (Test 2): " + sol.numOfUnplacedFruits(fruits2, baskets2)); // Expected: 3
    }
}
