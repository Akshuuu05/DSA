...
class Solution {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(sol.soupServings(50)); // Example small n
        System.out.println(sol.soupServings(100)); // Larger n
        System.out.println(sol.soupServings(5000)); // Very large n, should be ~1.0
    }
}
