...
class Solution {
    ...
    public static void main(String[] args) {
        ...
        String s1 = "ababa"; // example: "aba" + "aba" → max sum = 5
        String s2 = "babad"; // one split example

        System.out.println(sol.maxSum(s1)); // expected output: 5
        System.out.println(sol.maxSum(s2)); // test case
    }
}
